...
When this extension is enabled, the following function is added to the API under the `cip0142` namespace:
...
1. **Explicit Namespacing**: The extension uses the `cip0142` namespace to clearly separate its functionality from the base CIP-0030 API.
...
#### Overview
This implementation plan defines the systematic approach to realizing the proposed changes, ensuring alignment with the specified acceptance criteria and project objectives.
...
#### Implementors
- Lace team
- Optional: Other Cardano wallet providers
